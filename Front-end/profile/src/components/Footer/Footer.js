...
export default function Footer() {
  return (
    <footer dir="rtl" className="relative bg-gradient-to-b from-[#0a1a1f] to-[#0a0e12] text-white pt-32 pb-16 px-5 overflow-hidden">
      {/* تأثير ثلاثي الأبعاد للخلفية */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div 
          ...
          animate={{ scale: [1, 1.2, 1], rotate: [30, 60, 30] }}
          transition={{ duration: 18, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-1/3 right-1/3 w-56 h-56 bg-[#2d5a65] opacity-10 transform"
          style={{ clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' }}
        />
      </div>
      
      {/* موجات ثلاثية الأبعاد */}
      <div className="absolute top-0 left-0 right-0 h-40 overflow-hidden z-0">
        ...
        >
          <path 
            d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z" 
            opacity=".25" 
            className="fill-[#4ab3b9]" 
          ></path>
          <path 
            d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5,22.43-10.89,48-26.93,60.65-49.24V0Z" 
            opacity=".5" 
            className="fill-[#3a9ba1]" 
          ></path>
          <path 
            d="M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57c43-7.64,84.23-20.12,127.61-26.46,59-8.63,112.48,12.24,165.56,35.4C827.93,77.22,886,95.24,951.2,90c86.53-7,172.46-45.71,248.8-84.81V0Z" 
            className="fill-[#2a8389]" 
          ></path>
        </svg>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto z-10">
        ...
        >
          <div className="relative">
            <div className="text-5xl font-extrabold text-white relative">
              <span className="relative z-10 bg-clip-text text-transparent bg-gradient-to-r from-[#4ab3b9] to-[#a8e6e9]">
                معلم
              </span>
              <motion.span 
                animate={{ opacity: [0.5, 1, 0.5] }}
                transition={{ duration: 2, repeat: Infinity }}
                className="absolute -right-4 -top-4 text-4xl text-[#4ab3b9]"
              >
                .
              </motion.span>
            </div>
            <motion.div 
              ...
              className="absolute -inset-4 bg-gradient-to-r from-[#4ab3b9] to-[#a8e6e9] opacity-20 blur-lg rounded-full"
            />
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-20">
          ...
          <motion.div 
            ...
            className="group"
          >
            <div className="bg-[#0f252b] bg-opacity-60 backdrop-blur-md p-8 rounded-2xl border border-[#3a9ba1] border-opacity-30 h-full transform transition-all duration-500 group-hover:border-opacity-70 group-hover:bg-opacity-80">
              <h3 className="text-xl font-bold mb-6 text-[#a8e6e9] flex items-center">
                <span className="w-3 h-3 bg-[#4ab3b9] rounded-full mr-3"></span>
                معلومات التواصل
              </h3>
              
              <div className="space-y-4">
                <div className="flex items-start space-x-3 space-x-reverse">
                  <div className="p-2 bg-[#1e3d47] rounded-lg">
                    <FaPhoneAlt className="text-[#4ab3b9]" />
                  </div>
                  <div>
                    <p className="text-gray-400 text-sm">الهاتف</p>
                    <p className="text-white hover:text-[#a8e6e9] transition">+966 12 345 6789</p>
                  </div>
                </div>
                
                <div className="flex items-start space-x-3 space-x-reverse">
                  <div className="p-2 bg-[#1e3d47] rounded-lg">
                    <FaEnvelope className="text-[#4ab3b9]" />
                  </div>
                  <div>
                    <p className="text-gray-400 text-sm">البريد الإلكتروني</p>
                    <p className="text-white hover:text-[#a8e6e9] transition">info@moalem.com</p>
                  </div>
                </div>
                
                <div className="flex items-start space-x-3 space-x-reverse">
                  <div className="p-2 bg-[#1e3d47] rounded-lg">
                    <FaMapMarkerAlt className="text-[#4ab3b9]" />
                  </div>
                  <div>
                    <p className="text-gray-400 text-sm">العنوان</p>
                    <p className="text-white hover:text-[#a8e6e9] transition">المملكة العربية السعودية، جدة</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  >
                    <Link 
                      to={item.path} 
                      className="text-gray-300 hover:text-[#a8e6e9] transition flex items-center py-2"
                    >
                      <motion.span 
                        className="w-2 h-2 bg-[#4ab3b9] rounded-full mr-3 opacity-0 group-hover:opacity-100"
                        animate={{ x: [0, 5, 0] }}
                        transition={{ duration: 2, repeat: Infinity }}
                      />
                      {item.name}
          ...
          >
            <div className="bg-[#0f252b] bg-opacity-60 backdrop-blur-md p-8 rounded-2xl border border-[#3a9ba1] border-opacity-30 h-full transform transition-all duration-500 group-hover:border-opacity-70 group-hover:bg-opacity-80">
              ...
              <p className="text-gray-300 mb-6">
                حمّل تطبيق معلم الآن واحصل على أفضل الخدمات في أي وقت ومن أي مكان
              </p>
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-[#4ab3b9] to-[#a8e6e9] opacity-0 hover:opacity-20 transition-opacity duration-300"></div>
                  <img 
                    src={appStore} 
                    alt="App Store" 
                    className="w-full rounded-xl border border-[#3a9ba1]"
                  />
                </motion.a>
          ...
          >
            <div className="bg-[#0f252b] bg-opacity-60 backdrop-blur-md p-8 rounded-2xl border border-[#3a9ba1] border-opacity-30 h-full transform transition-all duration-500 group-hover:border-opacity-70 group-hover:bg-opacity-80">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: <FaWhatsapp />, color: "#25D366", name: "واتساب" },
                  { icon: <FaFacebookF />, color: "#1877F2", name: "فيسبوك" },
                  { icon: <FaTwitter />, color: "#1DA1F2", name: "تويتر" },
                  { icon: <FaInstagram />, color: "#E4405F", name: "إنستغرام" },
                ].map((social, index) => (
                  <motion.a
                    key={index}
                    href="#"
                  ...
                  >
                    <div className="text-2xl mb-2" style={{ color: social.color }}>
                      {social.icon}
                    </div>
        ...
        <motion.div 
          ...
          className="text-center pt-8 border-t border-[#1e3d47]"
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 space-x-reverse">
              <a href="#" className="text-gray-400 hover:text-[#a8e6e9] transition">الشروط والأحكام</a>
              <a href="#" className="text-gray-400 hover:text-[#a8e6e9] transition">سياسة الخصوصية</a>
              <a href="#" className="text-gray-400 hover:text-[#a8e6e9] transition">تواصل معنا</a>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-20 overflow-hidden z-0">
        ...
        >
          ...
          <path 
            d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5,22.43-10.89,48-26.93,60.65-49.24V0Z" 
            opacity=".5" 
            className="fill-[#1e6d73]" 
          ></path>
          <path 
            d="M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57c43-7.64,84.23-20.12,127.61-26.46,59-8.63,112.48,12.24,165.56,35.4C827.93,77.22,886,95.24,951.2,90c86.53-7,172.46-45.71,248.8-84.81V0Z" 
            className="fill-[#12575d]" 
          ></path>
        </svg>
      </div>
    </footer>
