...
const Cleaner = () => {
  return (
    <div className="relative overflow-hidden min-h-screen p-6" dir="rtl">
      <motion.div
        className="absolute top-90 right-[40%] w-80 h-60 rounded-full"
        style={{
          background: "linear-gradient(135deg, #CFF5EC, #94D1C3)",
      ...
      <div className="relative z-10">
        ...
        <div className="mb-10 max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {[
            { to: "/WaterSystems", text: "تنظيف المنزل بالكامل" },
            { to: "/LeakRepair", text: "تنظيف الأرضيات" },
            { to: "/Drainage", text: "تنظيف الغرف" },
            { to: "/WaterHeaters", text: "تنظيف الحمامات" },
            { to: "/HeatingSystems", text: "غسل الملابس وكيها" },
            { to: "/SystemInspection", text: "تنظيف الأثاث" },
            { to: "/Emergencies", text: "إزالة الروائح الكريهة" },
            { to: "/Emergencies", text: "تنظيف السجاد والموكيت" },
            { to: "/Emergencies", text: "تنظيف الساحات الخارجية" },
            { to: "/AdditionalServices", text: "خدمات إضافية حسب الطلب" },
          ].map(({ to, text }, i) => (
            <Link
              key={i}
              to={to}
        ...
        <div className="max-w-6xl mx-auto bg-[#CFF5EC] rounded-lg p-5 sm:p-10">
          <img src={img10} alt="Gardener" className="rounded-lg w-full sm:w-[90%] mx-auto" />
          <div className="pt-3 max-w-4xl mx-auto bg-white rounded-lg p-5 sm:p-7 mt-6">
            ...
            <p className="text-[#406F67] text-[17px] text-right">
               تنظيف الأرضيات وإزالة الغبار من جميع الغرف.<br />
               غسل الأواني وتنظيف المطبخ والأجهزة الكهربائية.<br />
               ترتيب الأثاث وإعادة تنظيم المساحات المنزلية.<br />
               غسل الملابس وكيها بعناية.<br />
               تنظيف النوافذ والأبواب وإزالة البقع.<br />
               تعقيم الحمامات وضمان نظافتها التامة.<br />
               تفريغ سلال المهملات واستبدال أكياس القمامة.<br />
               العناية بالسجاد وتنظيفه باستخدام المعدات المناسبة.<br />
               تقديم خدمات تنظيف عميق عند الحاجة.<br />
               استخدام مواد تنظيف آمنة وصديقة للبيئة.<br />
            </p>
          </div>
        </div>
      </div>
