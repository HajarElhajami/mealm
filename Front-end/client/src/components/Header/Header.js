...
//               className="w-full max-w-lg px-7 py-[22px] text-[17px] border border-primaryMid rounded-full shadow-sm text-black focus:ring-2 focus:ring-primaryMid focus:outline-none"
//             />
//             <button className="absolute right-[31%] bg-[#86C4B8] text-white p-[26px] pr-[65px] rounded-full hover:bg-[#406F67] transition">
//               <Search size={20} />
//             </button>
//           </div>

//           <div className="flex justify-center space-x-[88px] mt-20">
              ...
              <div className="relative z-10 text-center pt-16 px-6 md:px-20">
                ...
                {/* <div className="mt-[70px] flex items-center justify-center relative">
                  <input
                    type="text"
                    placeholder="ما الخدمة التي تحتاجها اليوم؟"
                    className="md-w-[85%] sm-w-[65%] px-7 py-[22px] text-[17px] border border-primaryMid rounded-full shadow-sm text-black focus:ring-2 focus:ring-primaryMid focus:outline-none"
                  />
                  <button className="absolute right-[27%] bg-[#86C4B8] text-white p-[26px] pr-[65px] rounded-full hover:bg-[#406F67] transition">
                    <Search size={20} />
                  </button>
                </div> */}
